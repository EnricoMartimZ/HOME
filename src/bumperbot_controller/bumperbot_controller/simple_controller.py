...
class SimpleController(Node):
    def __init__(self):
        ...
        self.odom_msg_.header.frame_id = "odom" #esse é  o frame parado, em relação ao qual o child frame se move
    ...
    def jointCallback(self, msg):
        ...
        time_in_seconds = max(dt.nanoseconds / S_TO_NS, 1e-9)  
        
        phi_left = dp_left / time_in_seconds
        phi_right = dp_right / time_in_seconds
    ...
    def wheel_motorCallback(self, msg: Float64MultiArray):
        ...
        self.get_logger().info("esquerda: %f, direita: %f" % (round(cmd_vel_esq), round(cmd_vel_dir)))
        codigo_motor_esquerdo = "Me "
        codigo_motor_direito = " Md "
        mensagem = codigo_motor_esquerdo + str(round(cmd_vel_esq)) + codigo_motor_direito + str(round(cmd_vel_dir)) +"\n"
