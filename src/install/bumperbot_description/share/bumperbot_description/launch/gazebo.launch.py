...
def generate_launch_description():
    ...
    world_path = PathJoinSubstitution([
            ...
            'worlds',
            PythonExpression(expression=["'", LaunchConfiguration("world_name"), "'", " + '.world'"])#acessa o conteudo da variavel
    ])
    ...
    bridge_params = os.path.join(get_package_share_directory("bumperbot_controller"), 'config', 'gz_bridge.yaml')
