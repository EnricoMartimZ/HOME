...
class SimpleQoSPublisher(Node):
    def __init__(self):
        ...
        if reliability == "best_effort":
            ...
            self.get_logger().error("Reliability %s doesnt exist" % reliability)
            return
        ...
        if durability == "volatile":
            ...
            self.get_logger().error("Durability %s doesnt exist" % durability)
            return
    ...
    def timerCallback(self):
        msg = String()
        msg.data = "hi ros2 - counter %d" % self.counter
