...
my_robot_interfaces__srv__GetTransform_Request__create(void)
{
...
my_robot_interfaces__srv__GetTransform_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
my_robot_interfaces__srv__GetTransform_Event__init(my_robot_interfaces__srv__GetTransform_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    my_robot_interfaces__srv__GetTransform_Event__fini(msg);
    return false;
  }
  // request
  if (!my_robot_interfaces__srv__GetTransform_Request__Sequence__init(&msg->request, 0)) {
    my_robot_interfaces__srv__GetTransform_Event__fini(msg);
    return false;
  }
  // response
  if (!my_robot_interfaces__srv__GetTransform_Response__Sequence__init(&msg->response, 0)) {
    my_robot_interfaces__srv__GetTransform_Event__fini(msg);
    return false;
  }
  return true;
...
void
my_robot_interfaces__srv__GetTransform_Event__fini(my_robot_interfaces__srv__GetTransform_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  my_robot_interfaces__srv__GetTransform_Request__Sequence__fini(&msg->request);
  // response
  my_robot_interfaces__srv__GetTransform_Response__Sequence__fini(&msg->response);
}

bool
my_robot_interfaces__srv__GetTransform_Event__are_equal(const my_robot_interfaces__srv__GetTransform_Event * lhs, const my_robot_interfaces__srv__GetTransform_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!my_robot_interfaces__srv__GetTransform_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!my_robot_interfaces__srv__GetTransform_Response__Sequence__are_equal(
...
bool
my_robot_interfaces__srv__GetTransform_Event__copy(
  const my_robot_interfaces__srv__GetTransform_Event * input,
  my_robot_interfaces__srv__GetTransform_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!my_robot_interfaces__srv__GetTransform_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!my_robot_interfaces__srv__GetTransform_Response__Sequence__copy(
...
my_robot_interfaces__srv__GetTransform_Event *
my_robot_interfaces__srv__GetTransform_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__srv__GetTransform_Event * msg = (my_robot_interfaces__srv__GetTransform_Event *)allocator.allocate(sizeof(my_robot_interfaces__srv__GetTransform_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_robot_interfaces__srv__GetTransform_Event));
  bool success = my_robot_interfaces__srv__GetTransform_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
my_robot_interfaces__srv__GetTransform_Event__destroy(my_robot_interfaces__srv__GetTransform_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_robot_interfaces__srv__GetTransform_Event__fini(msg);
...
bool
my_robot_interfaces__srv__GetTransform_Event__Sequence__init(my_robot_interfaces__srv__GetTransform_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__srv__GetTransform_Event * data = NULL;

  if (size) {
    data = (my_robot_interfaces__srv__GetTransform_Event *)allocator.zero_allocate(size, sizeof(my_robot_interfaces__srv__GetTransform_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_robot_interfaces__srv__GetTransform_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_robot_interfaces__srv__GetTransform_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
my_robot_interfaces__srv__GetTransform_Event__Sequence__fini(my_robot_interfaces__srv__GetTransform_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_robot_interfaces__srv__GetTransform_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
my_robot_interfaces__srv__GetTransform_Event__Sequence *
my_robot_interfaces__srv__GetTransform_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__srv__GetTransform_Event__Sequence * array = (my_robot_interfaces__srv__GetTransform_Event__Sequence *)allocator.allocate(sizeof(my_robot_interfaces__srv__GetTransform_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_robot_interfaces__srv__GetTransform_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
my_robot_interfaces__srv__GetTransform_Event__Sequence__destroy(my_robot_interfaces__srv__GetTransform_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_robot_interfaces__srv__GetTransform_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
my_robot_interfaces__srv__GetTransform_Event__Sequence__are_equal(const my_robot_interfaces__srv__GetTransform_Event__Sequence * lhs, const my_robot_interfaces__srv__GetTransform_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_robot_interfaces__srv__GetTransform_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
my_robot_interfaces__srv__GetTransform_Event__Sequence__copy(
  const my_robot_interfaces__srv__GetTransform_Event__Sequence * input,
  my_robot_interfaces__srv__GetTransform_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_robot_interfaces__srv__GetTransform_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_robot_interfaces__srv__GetTransform_Event * data =
      (my_robot_interfaces__srv__GetTransform_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_robot_interfaces__srv__GetTransform_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_robot_interfaces__srv__GetTransform_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_robot_interfaces__srv__GetTransform_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
