...
class GetTransform_Event(metaclass=Metaclass_GetTransform_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/GetTransform_Request, 1>',
        'response': 'sequence<my_robot_interfaces/GetTransform_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'GetTransform_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'GetTransform_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import GetTransform_Request
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import GetTransform_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetTransform(metaclass=Metaclass_GetTransform):
    ...
    from my_robot_interfaces.srv._get_transform import GetTransform_Event as Event
