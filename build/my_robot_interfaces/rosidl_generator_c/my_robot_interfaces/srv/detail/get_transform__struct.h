...
enum
{
  my_robot_interfaces__srv__GetTransform_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_robot_interfaces__srv__GetTransform_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetTransform in the package my_robot_interfaces.
typedef struct my_robot_interfaces__srv__GetTransform_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_robot_interfaces__srv__GetTransform_Request__Sequence request;
  my_robot_interfaces__srv__GetTransform_Response__Sequence response;
} my_robot_interfaces__srv__GetTransform_Event;

// Struct for a sequence of my_robot_interfaces__srv__GetTransform_Event.
typedef struct my_robot_interfaces__srv__GetTransform_Event__Sequence
{
